          ...
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  to="/"
                  className={`block py-2 pl-3 pr-4 rounded md:p-0 ${location.pathname === "/" ? "text-[#5aa1c2]" : "text-black"
              ...
              <li>
                <Link
                  to="/aboutus"
                  className={`block py-2 pl-3 pr-4 rounded md:p-0 ${location.pathname === "/aboutus"
                    ? "text-[#5aa1c2]"
                    : "text-black"
                    } hover:text-[#5aa1c2] active:text-[#5aa1c2]`}
                >
              ...
              <li>
                <Link
                  to="/hotelsprovider"
                  className={`block py-2 pl-3 pr-4 rounded md:p-0 ${location.pathname === "/hotelsprovider"
                    ? "text-[#5aa1c2]"
                    : "text-black"
                    } hover:text-[#5aa1c2] active:text-[#5aa1c2]`}
                >
              ...
              <li>
                <Link
                  to="/contactus"
                  className={`block py-2 pl-3 pr-4 rounded md:p-0 ${location.pathname === "/contactus"
                    ? "text-[#5aa1c2]"
                    : "text-black"
                    } hover:text-[#5aa1c2] active:text-[#5aa1c2]`}
                >
              ...
              <li>
                <Link
                  to="/providerlogin"
                  className={`block py-2 pl-3 pr-4 rounded md:p-0 ${location.pathname === "/providerlogin"
                    ? "text-[#5aa1c2]"
                    : "text-black"
                    } hover:text-[#5aa1c2] active:text-[#5aa1c2]`}
                >
