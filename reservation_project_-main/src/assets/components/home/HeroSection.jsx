...
const HeroSection = () => {
  return (
    <>
      <div
        className="hero relative overflow-hidden bg-no-repeat bg-cover w-full inset-0 z-0 "
        style={{
        ...
        <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black bg-opacity-60">
          <div className="flex justify-center items-center h-full">
            <div className="text-center text-white px-6 md:px-12">
              <h1 className="text-7xl font-bold font-serif md:text-6xl xl:text-7xl tracking-tight mb-12">
